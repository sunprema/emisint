defmodule Emisint.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind emisint", "esbuild emisint"],
      "assets.deploy": [
        "tailwind emisint --minify",
        "esbuild emisint --minify",
        "phx.digest"
      ],
