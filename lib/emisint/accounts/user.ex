defmodule Emisint.Accounts.User do
  use Ash.Resource,
    otp_app: :emisint,
  ...
  authentication do
    ...
    tokens do
      enabled? true
      token_resource Emisint.Accounts.Token
      signing_secret Emisint.Secrets
    ...
    strategies do
      password :password do
        ...
        resettable do
          sender Emisint.Accounts.User.Senders.SendPasswordResetEmail
